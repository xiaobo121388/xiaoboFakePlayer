...
export interface CapabilityEntry {
    ...
    readonly verification: "automated" | "bedrock_26_30_required" | "not_applicable";
    readonly detail: string;
}

export interface CapabilityMatrix {
    readonly gameVersion: "1.26.30";
    readonly serverVersion: "2.9.0-beta.1.26.30-stable";
    readonly serverUiVersion: "2.2.0-beta.1.26.30-stable";
    readonly gameTestVersion: "1.0.0-beta.1.26.30-stable";
    readonly capabilities: readonly CapabilityEntry[];
}

export const CAPABILITY_MATRIX: CapabilityMatrix = {
    gameVersion: "1.26.30",
    serverVersion: "2.9.0-beta.1.26.30-stable",
    serverUiVersion: "2.2.0-beta.1.26.30-stable",
    gameTestVersion: "1.0.0-beta.1.26.30-stable",
    capabilities: [
        {
            id: "simulated_player",
            availability: "enabled",
            verification: "bedrock_26_30_required",
        ...
        },
        {
            ...
            verification: "bedrock_26_30_required",
            detail: "公开组件存在，但写入语义尚未通过正式版 1.26.30 实机验证。",
        },
        {
